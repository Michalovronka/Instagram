...
function Navbar() {
    return (  
        <>
            <div className="flex justify-center gap-8 h-12 flex-row w-full bottom-0 fixed max-md:border-t border-t-slate-300 | md:w-18 md:block md:h-screen md:top-0 md:sticky md:pt-6 md:pb-9 md:px-3 md:border-r md:border-r-slate-300 | xl:w-61 ">
